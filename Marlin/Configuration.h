...
#define STRING_CONFIG_H_AUTHOR "Rafal Najda" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Dremel CNC"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 400, 400, 400, 400 }
